...
Todas as mensagens de commit devem seguir o padrão **Conventional Commits** para garantir clareza e rastreabilidade das mudanças. Exemplos de mensagens válidas:

- `feat: adiciona página de detalhes da tarefa`
- `fix: corrige erro no carregamento dos anexos`
- `docs: atualiza README com instruções de uso`
- `refactor: simplifica lógica de listagem de tarefas`
